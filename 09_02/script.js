...
// the event object contains lots of information about the event
const mousePosition = (event) => {
  posX.innerText = event.pageX;
  posY.innerText = event.pageY;
};

// For the entire window, trigger event any time the mouse moves
// when the mouse moves, tirgger the function mousePosition
